...
<title>Delete Account - Vendor Management</title>
			...
			<div class="col-md-5 offset-md-4">
				<div class="card card-sh">
					<div class="card-header text-center">
						<p class="fs-3 text-uppercase">Delete Account</p>
					...
					<div class="card-body">
						<form action="delete-account" method="post">
							...
							<button type="submit" id=""
								class="btn form-control btn-primary btn-sm mt-4 mb-2">Delete</button>
