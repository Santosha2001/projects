...
<div class="container mt-5 p-5">
							...
							<form>
								<div class="mb-3">
									<label class="form-label">Email Address</label> <input
										class="form-control form-inputs" name="email" type="email">
								</div>

								<!-- <div class="mb-3">
									<label class="form-label">Generate OTP</label> <input
										class="form-control" name="password" type="password">
								</div> -->
								<button type="submit"
									class="btn bg-primary text-white col-md-12">Generate OTP</button>
							</form>
						</div>
					</div>
				</div>
	...
	<footer class="py-1 mt-2 footer-1 fixed-bottom" >
